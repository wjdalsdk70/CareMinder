        ...
        <header className="patient-header">
            <div className="left">
                <img
                    ...
                    src={Logo}
                />
                <h2>{patient.patientHeader} {total}</h2>
            </div>

            <div className="status">
                <h2>{patient.patientHeaderWaiting} {waiting}</h2>
                <h2>{patient.patientHeaderProcess} {progress}</h2>
                <h2>{patient.patientHeaderDone} {finished}</h2>
            </div>
